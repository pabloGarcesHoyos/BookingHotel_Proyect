...
//        users.add((User) controllerUser.getAllUsers());
        
        System.out.println(users);
        // Obtén el número de registros de la base de datos
        
        int numRegistros = controllerUser.getAllUsers().size();
        ...
        for (int i = 0; i < numRegistros; i++) {
            ...
            JLabel title = new JLabel("Nombre " + (controllerUser.getAllUsers().get(i).getUserName() + 1));
